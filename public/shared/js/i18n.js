...
'drawer.contracts': 'Contratos',
 ...
 'drawer.contractsDesc': 'Tokens del ecosistema en Base Mainnet. Agrégarlos a MetaMask para ver saldos.',
'contracts.auraDesc': 'Utility / gas social',
'contracts.alemDesc': 'Gobernanza DAO (veSTAKE)',
'contracts.network': 'Red: Base Mainnet (Chain ID: 8453)',
'contracts.addMetaMask': '+ MetaMask',
'contracts.added': '✓ Agregado',
'drawer.about': 'Acerca de',
 ...
 'services.admin': 'Panel de Administración — Control centralizado desde ia.alemty.eth. Reinicio de agentes, sincronización de pools, actualización de OVRlands, parada de emergencia (Constitución §Emergencias).',
 ...
 'notif.prev': '← Anterior',
 'notif.next': 'Siguiente →',
 'notif.page': 'Página',
 'notif.pageOf': 'de',
 'notif.connectWallet': 'Conecta tu wallet y verifica SIWE para ver notificaciones.',
 'notif.verifySiwe': 'Verifica SIWE para habilitar notificaciones.',
 'notif.actionLike': 'le dio like a',
 'notif.actionPoint': 'te dio',
 'notif.actionIn': 'en',
 'notif.actionComment': 'comentó en',
 'notif.viewProfile': 'ver perfil',
 'notif.empty': 'No hay interacciones recientes.',

 'mod.title': 'Moderación',
 'mod.close': 'Cerrar',
 'mod.loading': 'Cargando…',
 'mod.noPerms': 'No tienes permisos de moderación.',
 'mod.needSiwe': 'Necesitas SIWE para moderar.',
 'mod.noEndpoint': 'Sin endpoint aún (SOON). Status:',
 'mod.noJson': 'Respuesta no JSON (SOON).',
 'mod.noReports': 'No hay reportes pendientes',
 'mod.noReason': 'Sin motivo',
 'mod.actionsNext': 'Acciones — siguiente fase.',
 'mod.errorLoading': 'Error cargando reportes (SOON).',
 'notif.close': 'Cerrar',
 ...
 'profile.tab.status': 'ESTADO',
 'profile.tab.user': 'User',
 'profile.tab.farm': 'FARM',
 'profile.tab.dex': 'DEX',
 ...
 'profile.rewards.pendingMint': 'Pendiente de minteo',
 'profile.rewards.claimed': 'Reclamado',
 'profile.level': 'Nivel —',
 'profile.levelDefault': 'Nivel —',
 'profile.dharma': 'Dharma',
 'profile.karma': 'Karma',
 'profile.auraOnChain': 'AURA on-chain',
 'profile.veAlem': 'veALEM',
 'profile.slotItem': 'Item (Nivel)',
 'profile.slotRol': 'Rol',
 'profile.slotVeNft': 'veNFT',
 'profile.slotAssets': 'Assets',
 'profile.slotAgent': 'Agent',
 'profile.slotLands': 'Lands',
 'profile.connectWallet': 'Conecta tu wallet (☰)',
 'profile.status': 'Estado',
 'profile.statusConnect': 'Panel MMORPG. Conecta tu wallet desde ☰ para ver tu progreso.',
 'profile.statusPanel': 'Panel MMORPG.',
 'profile.connected': 'Conectado',
 'profile.did': 'DID',
 'profile.pointsReceived': 'Points recibidos',
 'profile.likesReceived': 'Likes recibidos',
 'profile.commentsReceived': 'Comentarios recibidos',
 ...
 'profile.rewards.tokenomics': 'DEX · Tokenomics',
 'profile.rewards.description': 'AURA on-chain vs pendiente de reclamar. El AURA se transfiere desde la wallet distribuidora del ecosistema.',
 'profile.rewards.onchain': 'AURA en tu wallet (on-chain)',
 'profile.rewards.pending': 'AURA por reclamar (off-chain)',
 'profile.rewards.auraPending': '🔵 AURA por reclamar',
 'profile.rewards.auraTooltip': 'AURA acumulado por interacciones (likes/points + farm) pendiente de recibir on-chain desde la wallet distribuidora',
 'profile.rewards.alemTooltip': 'Rewards de pool LP AURA/ALEM (próximamente)',
 'profile.rewards.bribes': '💎 Bribes',
 'profile.rewards.bribesTooltip': 'Incentivos de voto en gauge (próximamente)',
 'profile.rewards.lpFees': '💧 Fees LP',
 'profile.rewards.lpFeesTooltip': 'Comisiones acumuladas por proveer liquidez (próximamente)',
 'profile.rewards.flow': 'Flujo: Interacciones → AURA off-chain',
 'profile.rewards.flowEnd': 'Wallet distribuidora te transfiere AURA → AURA on-chain',
 'profile.rewards.none': '✨ No hay recompensas pendientes',
 'profile.rewards.claimAll': '⚡ Reclaim Rewards (todo)',
 'profile.rewards.claiming': 'Reclamando...',
 'profile.rewards.agentProcessing': 'El agente está procesando tu reclaim...',
 'profile.rewards.connectWalletFirst': '❌ Conecta tu wallet primero.',
 'profile.rewards.errorClaim': 'Error al reclamar',
 'profile.rewards.error': '❌ Error: ',
 'profile.rewards.unknown': 'desconocido',
 'profile.farm.title': '🎣 FARM',
 'profile.farm.connectWallet': 'Conecta tu wallet para pescar AURA.',
 'profile.farm.farming': 'Farmeando AURA',
 'profile.farm.streak': 'Racha',
 'profile.farm.day': 'día',
 'profile.farm.days': 's',
 'profile.farm.total': 'Total acumulado',
 'profile.farm.castBait': 'Lanzar cebo',
 'profile.farm.fishedToday': 'Ya pescaste hoy',
 'profile.farm.fishing': 'Pesca en curso...',
 'profile.farm.noHistory': 'Aún no has pescado nada.',
 ...
 'dao.createPost': 'Crear post',
 'dao.createPostSub': 'Modo v1: Foro Online ENS IPFS SQL.',
 'dao.postTitle': 'Título…',
 'dao.postBody': 'Escribe tu post…',
 'dao.publish': 'Publicar',
 'dao.latestPost': 'Último post',
 'dao.rooms': 'Salas',
 'dao.roomsSub': 'Crea espacios de gobernanza o entra a backrooms.',
 'dao.governanceBtn': 'Gobernanza',
 'dao.backroomsBtn': 'Backrooms',
 'dao.feed': 'Feed',
 'dao.feedSub': 'Explora, vota, abre posts y participa',
 'dao.search': 'Buscar…',
 'dao.clearSearch': 'Limpiar',
 'dao.topWeek': 'Top semana',
 'dao.topMonth': 'Top mes',
 'dao.post': 'Post',
 'dao.sections': 'Secciones',
 ...
 'dex.nobleFormula': 'Fórmula de Nobleza',
 ...
 'dex.nobleNft3': 'Representan cargo político, no propiedad',
 ...
 'ia.toast.configuring': 'Abriendo configuración de',
 'ia.toast.on': 'en',
...
'drawer.contractsDesc': 'Ecosystem tokens on Base Mainnet. Add them to MetaMask to check balances.',
'contracts.auraDesc': 'Utility / social gas',
'contracts.alemDesc': 'DAO Governance (veSTAKE)',
'contracts.network': 'Network: Base Mainnet (Chain ID: 8453)',
'contracts.addMetaMask': '+ MetaMask',
'contracts.added': '✓ Added',
 'drawer.about': 'About',
 ...
 'services.admin': 'Admin Panel — Centralized control from ia.alemty.eth. Agent restart, pool sync, OVRlands update, emergency stop (Constitution §Emergencies).',
 ...
 'notif.page': 'Page',
 'notif.pageOf': 'of',
 'notif.connectWallet': 'Connect your wallet and verify SIWE to see notifications.',
 'notif.verifySiwe': 'Verify SIWE to enable notifications.',
 'notif.actionLike': 'liked',
 'notif.actionPoint': 'gave you',
 'notif.actionIn': 'on',
 'notif.actionComment': 'commented on',
 'notif.viewProfile': 'view profile',
 'notif.empty': 'No recent interactions.',

 'profile.title': 'Profile',
 'profile.close': 'Close',
 'profile.tab.status': 'STATUS',
 'profile.tab.user': 'User',
 'profile.tab.farm': 'FARM',
 'profile.tab.dex': 'DEX',
 ...
 'profile.rewards.pendingMint': 'Pending mint',
 'profile.rewards.claimed': 'Claimed',
 'profile.rewards.tokenomics': 'DEX · Tokenomics',
 'profile.rewards.description': 'AURA on-chain vs pending claim. AURA is transferred from the ecosystem distributor wallet.',
 'profile.rewards.onchain': 'AURA in your wallet (on-chain)',
 'profile.rewards.pending': 'AURA pending claim (off-chain)',
 'profile.rewards.auraPending': '🔵 AURA pending claim',
 'profile.rewards.auraTooltip': 'AURA accumulated from interactions (likes/points + farm) pending on-chain receipt from the distributor wallet',
 'profile.rewards.alemTooltip': 'AURA/ALEM LP pool rewards (coming soon)',
 'profile.rewards.bribes': '💎 Bribes',
 'profile.rewards.bribesTooltip': 'Gauge vote incentives (coming soon)',
 'profile.rewards.lpFees': '💧 LP Fees',
 'profile.rewards.lpFeesTooltip': 'Liquidity provision fees (coming soon)',
 'profile.rewards.flow': 'Flow: Interactions → AURA off-chain',
 'profile.rewards.flowEnd': 'Distributor wallet sends AURA → AURA on-chain',
 'profile.rewards.none': '✨ No pending rewards',
 'profile.rewards.claimAll': '⚡ Reclaim Rewards (all)',
 'profile.rewards.claiming': 'Reclaiming...',
 'profile.rewards.agentProcessing': 'The agent is processing your reclaim...',
 'profile.rewards.connectWalletFirst': '❌ Connect your wallet first.',
 'profile.rewards.errorClaim': 'Error claiming',
 'profile.rewards.error': '❌ Error: ',
 'profile.rewards.unknown': 'unknown',
 'profile.farm.title': '🎣 FARM',
 'profile.farm.connectWallet': 'Connect your wallet to fish AURA.',
 'profile.farm.farming': 'Farming AURA',
 'profile.farm.streak': 'Streak',
 'profile.farm.day': 'day',
 'profile.farm.days': 's',
 'profile.farm.total': 'Total accumulated',
 'profile.farm.castBait': 'Cast bait',
 'profile.farm.fishedToday': 'Already fished today',
 'profile.farm.fishing': 'Fishing in progress...',
 'profile.farm.noHistory': 'You haven\'t fished anything yet.',
 'profile.level': 'Level —',
 'profile.levelDefault': 'Level —',
 'profile.dharma': 'Dharma',
 'profile.karma': 'Karma',
 'profile.auraOnChain': 'AURA on-chain',
 'profile.veAlem': 'veALEM',
 'profile.slotItem': 'Item (Level)',
 'profile.slotRol': 'Role',
 'profile.slotVeNft': 'veNFT',
 'profile.slotAssets': 'Assets',
 'profile.slotAgent': 'Agent',
 'profile.slotLands': 'Lands',
 ...
 'profile.statusConnect': 'MMORPG Panel. Connect your wallet from ☰ to see your progress.',
 'profile.statusPanel': 'MMORPG Panel.',
 'profile.connected': 'Connected',
 'profile.did': 'DID',
 'profile.pointsReceived': 'Points received',
 'profile.likesReceived': 'Likes received',
 'profile.commentsReceived': 'Comments received',
 ...
 'mod.close': 'Close',
 'mod.loading': 'Loading…',
 'mod.noPerms': 'You do not have moderation permissions.',
 'mod.needSiwe': 'You need SIWE to moderate.',
 'mod.noEndpoint': 'No endpoint yet (SOON). Status:',
 'mod.noJson': 'Non-JSON response (SOON).',
 'mod.noReports': 'No pending reports',
 'mod.noReason': 'No reason',
 'mod.actionsNext': 'Actions — next phase.',
 'mod.errorLoading': 'Error loading reports (SOON).',
 ...
 'dao.createPost': 'Create post',
 'dao.createPostSub': 'v1: Online Forum ENS IPFS SQL.',
 'dao.postTitle': 'Title…',
 'dao.postBody': 'Write your post…',
 'dao.publish': 'Publish',
 'dao.latestPost': 'Latest post',
 'dao.rooms': 'Rooms',
 'dao.roomsSub': 'Create governance spaces or enter backrooms.',
 'dao.governanceBtn': 'Governance',
 'dao.backroomsBtn': 'Backrooms',
 'dao.feed': 'Feed',
 'dao.feedSub': 'Explore, vote, open posts and participate',
 'dao.search': 'Search…',
 'dao.clearSearch': 'Clear',
 'dao.topWeek': 'Top Week',
 'dao.topMonth': 'Top Month',
 'dao.post': 'Post',
 'dao.sections': 'Sections',
 // DAO panel titles (used in JS PANEL_MODEL with t())
 ...
 'dex.nobleFormula': 'Nobility Formula',
 ...
 'dex.nobleNft3': 'Represent political office, not ownership',
 ...
 'ia.toast.configuring': 'Opening configuration for',
 'ia.toast.on': 'on',
...
const FLAG_MX = `<svg viewBox="0 0 36 24" width="20" height="14" style="border-radius:2px;display:block;">
 <defs>
 <clipPath id="clipDiagMx"><polygon points="36,0 0,24 0,0"/></clipPath>
 <clipPath id="clipDiagEs"><polygon points="36,0 36,24 0,24"/></clipPath>
 </defs>
 <!-- México completo (triángulo sup-izq): verde-blanco-rojo -->
 ...
 <!-- España completo (triángulo inf-der): rojo-amarillo-rojo -->
...
const FLAG_US = `<svg viewBox="0 0 36 24" width="20" height="14" style="border-radius:2px;display:block;">
 <defs>
 <clipPath id="clipDiagUs"><polygon points="36,0 0,24 0,0"/></clipPath>
 <clipPath id="clipDiagGb"><polygon points="36,0 36,24 0,24"/></clipPath>
 </defs>
 <!-- USA completo (triángulo sup-izq) -->
