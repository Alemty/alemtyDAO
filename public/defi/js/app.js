...
function renderAllCards(){
  ...
  renderTokenCard({
    ...
    title: "$ALEM / veALEM",
    meta: "Poder bloqueado (decay) · anti-plutocracia",
    tags: ["Lock", "Decay", "Timelock"],
    actions: [
      {
        key:"vealem-modelo",
        label:"Modelo",
        modalTitle:"veALEM — modelo",
        modalHtml: () => `
          <div class="h2">veALEM — modelo</div>
          <p class="muted">
            Poder político no líquido: ALEM bloqueado por tiempo genera poder que decae linealmente y requiere relock.
            Decisiones críticas pasan por timelock y pueden revisarse.
          </p>
        `
      },
      {
        ...
        label:"Reglas",
        primary:true,
        modalTitle:"veALEM — reglas de gobernanza",
        modalHtml: () => `
          <div class="h2">Gobernanza (A/B/C/D)</div>
          <p class="muted">
            Gobernanza económica/política usa ve-lock. Quórums y timelocks varían por tipo de decisión.
          </p>
          <div class="small muted">
            Protecciones: sin poder eterno, sin compra directa de decisiones.
          </div>
        `
      }
    ]
