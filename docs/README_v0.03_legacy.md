...
#### Flujo
- El usuario firma un mensaje SIWE desde el frontend.
- Un Worker stateless verifica dominio, chain ID, firma y nonce anti‑replay.
- El frontend guarda el DID en localStorage por origen.
#### Notas importantes
